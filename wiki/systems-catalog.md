...
| GS1 GPC | Global (GS1) | 6,450 | Global Product Classification (Segment / Family / Class / Brick), Nov 2025 release |
...
## Process / Activity Frameworks

| System | Region | Codes | Authority | Purpose |
|--------|--------|-------|-----------|---------|
| APQC PCF (Skeleton) | Global | 13 | APQC | Cross-Industry Process Classification Framework, top-level categories. The 13 process categories (operating processes 1.0-6.0; management and support 7.0-13.0) are the canonical pan-industry process anchor. Levels 2-5 (~1,500 detailed elements) require the official APQC spreadsheet. |
