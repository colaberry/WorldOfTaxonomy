...
| [docs/handover/marketing-handover.md](docs/handover/marketing-handover.md) | Onboarding doc for the marketer running the multi-channel public launch: pitches, audience segments, channel sequencing (Phase 0/1/2/3), brand assets inventory, press-kit checklist, KPIs, decisions only Ram can make, common pitfalls. |
