...
_ALLOWLIST: List[str] = [
    ...
    "unicode_emoji",
    # Round 2: regulatory / compliance / standards frameworks
    "ms_drg",
    "iso_31000",
    "ford_frascati",
    "seea",
    ...
    "reg_iso_37001",
    "reg_iso_14001",
    # Round 3: untapped public reference taxonomies + non-medical regs
    "sdg",
    "jel",
    "acm_ccs",
    "scopus_asjc",
    ...
    # tariff systems, and reference taxonomies. Excludes proprietary
    # clinical skeletons (CPT, SNOMED, RxNorm, ICD-10 national mods, etc.)
    # which need authoritative-source ingesters.
    "reg_aicpa",
    "reg_ashrae",
    "reg_asme",
    "reg_basel3",
    ...
    "reg_eu_cra",
    "reg_eu_data_act",
    "reg_eu_deforestation",
    "reg_eu_machinery",
    "reg_eu_packaging",
    "reg_eu_whistleblower",
    "reg_fasb",
    "reg_ffiec",
    "reg_ftc_safeguards",
    "reg_icao_annex",
    ...
    "reg_wto_sps",
    "reg_wto_tbt",
    # Round 4: national industrial classifications + tariff systems
    "afcfta_tariff",
    "asean_tariff",
    "cnae_2012",
    "csic_2017",
    ...
    "tsic_2009",
    "uk_trade_tariff",
    # Round 4: reference taxonomies, frameworks, technical standards
    "3gpp_specs",
    "ai_model_type",
    "allergen_list",
    "anzsrc_seo",
