"""Backfill UN M.49 node descriptions from ``data/iso3166_all.csv``."""
...
from world_of_taxonomy.ingest.un_m49_descriptions import build_m49_mapping
...
async def _run(dry_run: bool) -> int:
    ...
    print(f"  Building M.49 mapping from {source.name}...")
    mapping = build_m49_mapping(source)
    print(f"  Built {len(mapping):,} descriptions (countries + regions + world)")
